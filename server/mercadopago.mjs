// Assinatura mensal via Mercado Pago (Preapproval — cobrança recorrente por cartão), pra
// custear os créditos de IA que o app consome. Sem SDK: chama a API REST direto (mesmo estilo
// de server/wger.mjs), sem depender de um "Plano" pré-cadastrado no painel do Mercado Pago —
// tudo controlado por código/variável de ambiente.
